    ...
    <body>
    	   ...
    	   <!--loading page  start here-->
            ...
            <div class="address-loader">
              ...
              <?php endif; ?>
                    ...
                    <?php $mainsite = site_url(); ?>
					<?php if ($mainsite == 'http://realvision.ca/90-devere-gardern-non-branded') { ?>
        ...
        <header class="clearfix main_header" id="header_section">
            ...
            <div class="container-fluid top-fluid header_section">
                    ...
                    <nav class="navbar navbar-default" id="nav">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="navbar-header">
                                ...
                                <button type="button" class="navbar-toggle collapsed" data-style="fast" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false" id="menu-top">

                                </button>

                                <a class="logo h1_logo"><?php echo get_bloginfo('name');?><!--90 De Vere Gardens, North York, ON M5M 3G2--></a>
                ...
                <div class="clearfix mobile-bg-image ">
                ...
                <div class="header-bottom" id="header-bottom">
                    ...
                    <div class="text-center">
                        ...
                        <div>
                            ...
                            <h1><span class="home-no">90 De Vere Gardens,</span></h1>

                            <h2>North York, ON M5M 3G2</h2>

                            <ul class="list-inline">

                                <li><a href="#photo-panel-scroll" id="hbl_1" class="hd-icon"><img src="<?php echo get_template_directory_uri();?>/images/photo-icon-title.png" alt="photoicon" class="hd-icon-img" /><br><br><span>photos</span></a></li>

                                <li><a href="#section-video" id="hbl_2" class="hd-icon"><img src="<?php echo get_template_directory_uri();?>/images/video-icon-title.png" alt="videoicon" class="hd-icon-img"/><br><br><span>video</span></a></li>
        ...
        <div id="video-wrap" class="hidden-xs ">
            ...
            <video poster="<?php echo get_template_directory_uri();?>/images/top-video-bg.jpg" id="my-video" preload="none" autobuffer="none" autoplay loop muted metadata="true" automatic="true">
                <source src="<?php echo get_template_directory_uri();?>/video/converted_5f206838.webm" type="video/webm">
                <source src="<?php echo get_template_directory_uri();?>/video/Drone-Clip-1080p_CLIPCHAM-P_360p.mp4" type="video/mp4">
               
            </video>

            <!--video poster="<?php echo get_template_directory_uri();?>/background/img/106988/www_xl/001_4420_Camley_Way_106988_153761.jpg" id="my-video" preload="none" autobuffer="none" autoplay loop muted metadata="true" automatic="true">

                <source src="http://player.vimeo.com/external/151521325.hd.mp4?s=0e5d11519770cf7b28054c73876e7ffdb5c87b65&amp;profile_id=113&amp;oauth2_token_id=398748072" type="video/mp4">
