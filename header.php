...
<div class="spinner-wrapper">
    <div id="loading-overlay" class="loading-overlay">
        <div id="loader">
            ...
            <h1 class="h1_white"><img src="<?php echo get_template_directory_uri(); ?>/images/logo-video-new.png"
                                      alt=""/></h1>
            <div class="loader7">
    ...
    <div class="container-fluid top-fluid header_section">
            ...
            <nav class="navbar navbar-default" id="nav">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        <button type="button" class="navbar-toggle collapsed" data-style="fast" data-toggle="collapse"
                                data-target="#bs-example-navbar-collapse-1" aria-expanded="false"
                                id="menu-top"></button>
                        <a class="logo h1_logo">
							<?php echo get_bloginfo( 'name' ); ?><!--90 De Vere Gardens, North York, ON M5M 3G2--></a>
                    </div>
        ...
        <div class="header-bottom" id="header-bottom">
            <div class="text-center">
                <div>
                    <h1><span class="home-no">50 Martin Trail</span></h1>
                    <h2>New Tecumseth, ON L0G 1W0</h2>
                    <ul class="list-inline">
                        <li><a href="#photo-panel-scroll" id="hbl_1" class="hd-icon"><img
                                        src="<?php echo get_template_directory_uri(); ?>/images/photo-icon-title.png"
                                        alt="photoicon" class="hd-icon-img"/><br>
                                <br>
                                <span>photos</span></a></li>
<!--                        <li><a href="#section-video" id="hbl_2" class="hd-icon"><img-->
<!--                                        src="--><?php //echo get_template_directory_uri(); ?><!--/images/video-icon-title.png"-->
<!--                                        alt="videoicon" class="hd-icon-img"/><br>-->
<!--                                <br>-->
<!--                                <span>video</span></a></li>-->
                        <li><a href="#" id="hbl_4" class="hd-icon"><img
                                        src="<?php echo get_template_directory_uri(); ?>/images/3d-icon-title.png"
                                        alt="3dicon" class="hd-icon-img"/><br><br><span>3d</span></a></li>
<!--                        <li><a href="#floor_plan" id="hbl_4" class="hd-icon"><img-->
<!--                                        src="--><?php //echo get_template_directory_uri(); ?><!--/images/floor-icon-title.png"-->
<!--                                        alt="3dicon" class="hd-icon-img"/><br><br><span>floorplan</span></a></li>-->
...
<div id="video-wrap" class="hidden-xs ">
    ...
    <video poster="<?php echo get_template_directory_uri(); ?>/images/top-video-bg.jpg" id="my-video" preload="none"
           autobuffer="none" autoplay loop muted metadata="true" automatic="true">
