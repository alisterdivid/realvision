...
<section class="more-info text-center"> <img src="<?php echo get_template_directory_uri();?>/images/home-info-icon-panel.png" title="Property video" alt="Property video">
...
<section id="section2"  class="padding_top_nav">
  <div class="section-header text-center"> <img src="<?php echo get_template_directory_uri();?>/images/photo-icon-panel.png" title="Property video" alt="Property video" >
    ...
    <div class="row">
      <div style="position:relative"> 
							   ...
							   $args = array( 'post_type' => 'property_photos', 'posts_per_page' => -1, 'order'=>'ASC' ) ;
                                ...
                                if($the_query->have_posts()) while ($the_query->have_posts()) : $the_query->the_post();
                                    ...
                                    $main_image = get_field('property_photo_main_image');
                                       ...
                                       ?>
          <div class="item img-<?php echo $i;?>"> <img  alt="" title="<?php the_title()?>" data-name="photoSlide1" data-src-sm="<?php echo $main_image['url'];?>"

                                          data-src="<?php echo $main_image['url'];?>" class="owl-lazy">
        ...
        <div class="main-slide-control">
          <button id="showtooltip" type="button" data-toggle="tooltip" data-placement="top" title="Info" data-original-title=""></button>
          <button id="playslide" class="play" type="button" data-toggle="tooltip" data-placement="top" title="play" data-original-title=""></button>
          <button id="pauseslide" class="stop" type="button" data-toggle="tooltip" data-placement="top" title="stop" data-original-title=""></button>
          <a href="#property_gallery"  data-slide-to="12" id="slide-status" > <span data-toggle="tooltip" data-placement="top" title="Full Screen"
        ...
        <div class="dropdown slider-dropdown text-left">
          <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="true"> <span class="slidetitle"></span> <span class="num"></span> 
